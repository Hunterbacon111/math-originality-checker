...
<div style='text-align: center; color: gray;'>
    <p><strong>数学题目审核系统</strong> v1.0</p>
    <p>GPT-5.1 | DeepSeek R1 | Doubao Seed 1.6 Thinking | Mistral Pixtral</p>
    <p>支持文字输入 + 图片OCR识别 | 多模型智能分析</p>
</div>
